    ...
    productsHTML += `
        <div class="product-container">
          ...
          <div class="product-quantity-container ">
            <select class = "product-quantity-js-${product.id}">
...
addToCartBtn.forEach((button) => {
  button.addEventListener('click',()=>{
    ...
    let matchingItem;
     ...
     let quantityControl = document.querySelector(`.product-quantity-js-${productId}`);

    let quantity = Number(quantityControl.value); // convert to number
